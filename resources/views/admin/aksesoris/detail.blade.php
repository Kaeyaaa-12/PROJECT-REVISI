        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
                <div class="mb-4">
                    <img src="{{ $accessory->image ? asset('storage/' . $accessory->image) : 'https://via.placeholder.com/600x700' }}"
                        alt="{{ $accessory->name }}" class="w-full h-auto rounded-lg shadow-lg">
                </div>
            </div>
            ...
            <div class="bg-gray-800 p-8 rounded-lg shadow-lg">
                ...
                <div class="mb-8">
                    ...
                    <form action="{{ route('admin.renters.accessory.store', $accessory) }}" method="POST">
                        @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-3 mb-4 max-h-48 overflow-y-auto">
                        @forelse ($accessory->renters->sortBy('rental_date') as $renter)
                            <div class="flex justify-between items-center bg-gray-700 p-3 rounded-md">
                                ...
                                <div class="flex space-x-2">
                                    <form action="{{ route('admin.renters.accessory.destroy', $renter) }}" method="POST"
