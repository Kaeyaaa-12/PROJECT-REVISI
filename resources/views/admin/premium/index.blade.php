    ...
    <div style="background-color: #2d2d2d;" class="p-4 sm:p-8 rounded-lg">
        <div class="flex flex-col sm:flex-row justify-between items-center mb-12 space-y-4 sm:space-y-0">
            <div class="text-center w-full">
                <h1 class="text-3xl sm:text-4xl font-bold">Koleksi Premium</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <div style="background-color: #242424;"
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mt-2">
                            <p class="text-gray-400 text-sm">Stok: {{ $collection->stock }}</p>
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.koleksi.premium.edit', $collection) }}"
                                ...
                                <form action="{{ route('admin.koleksi.premium.destroy', $collection) }}" method="POST"
            ...
            @empty
                <p class="text-white col-span-full text-center">Belum ada koleksi premium.</p>
            @endforelse
        </div>
        <div class="mt-8">
            {{ $collections->links() }}
