...
@section('title', 'Tambah Koleksi Premium')

@section('content')
    <h1 class="text-4xl font-bold text-center mb-8">Tambah Koleksi Premium</h1>

    <div class="bg-gray-800 p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
        <form action="{{ route('admin.koleksi.premium.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
