    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg">
                <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">{{ $collection->category }}</h1>
                <h2 class="text-4xl sm:text-5xl font-extrabold text-white mb-6">{{ $collection->name }}</h2>
                ...
                <div class="mb-8">
                    ...
                    <form action="{{ route('admin.renters.original.store', $collection) }}" method="POST">
                        @csrf
                        ...
                        @forelse ($collection->renters->sortBy('rental_date') as $renter)
                            <div class="flex justify-between items-center bg-gray-700 p-3 rounded-md">
                                ...
                                <div class="flex space-x-2">
                                    <form action="{{ route('admin.renters.original.destroy', $renter) }}" method="POST"
