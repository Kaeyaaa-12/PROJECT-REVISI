...
@section('title', 'Edit Koleksi Original')

@section('content')
    <h1 class="text-4xl font-bold text-center mb-8">Edit Koleksi Original</h1>

    <div class="bg-gray-800 p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
        <form action="{{ route('admin.koleksi.original.update', $collection) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-4">
